...
def hello():
    ...
    num = request.args.get('num', default=8, type=int)
    ...
    jkg = '["' + '","'.join(random.sample(jkg0, num)) + '"]'


    ### HTML and javascript codes to reply as HTTP
#    Content-type: text/html
    ...
    <pre>
 文字を入れ替えて、縦に並んだ４字で4字熟語を作ってください。
 文字をクリックすると赤くハイライトしますので、別の文字を
 クリックして文字を入れ替えてください。
 正解した熟語はグレーアウトします。
    </pre>
    ...
    <button type="button" id="b1" onClick="location.reload();">次の問題</button>
    </div>
